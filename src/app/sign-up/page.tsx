...
function SimpleCheckbox({ id, name, checked, onChange }: {
  id: string;
  name: string;
  checked: boolean;
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-white px-4">
      <div className="w-full max-w-md py-10 mx-auto">
        ...
        <h2 className="text-xl font-bold text-black mb-6 text-center">회원가입</h2>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6 w-full items-center">
          ...
          <Button color="black" size="lg" className="w-full" type="submit">
            확인
          </Button>
